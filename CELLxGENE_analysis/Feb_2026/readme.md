...
Both scripts reproduce the inverse relationship between tissue-level effector (i.e., CD8+ T) cell prognosticity and metabolic intensity proxied by metabolic gene expression, as shown in Table 1 of the manuscript.
